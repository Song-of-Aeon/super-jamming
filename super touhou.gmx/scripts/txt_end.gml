...
message[0] = "...And that was the story of
Fujiwara no Mokou's life.";
message[1] = "Did something happen after that?";
message[2] = "Well, even if it did,
would it have been something that
could have been called 'living'?";
message[3] = "No,
